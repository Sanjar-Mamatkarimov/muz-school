...
JAZZMIN_SETTINGS = {
    ...
    # Иконки для твоих моделей (названия приложений и моделей должны совпадать)
    "icons": {
        "auth": "fas fa-users-cog",
        "auth.user": "fas fa-user",
        "auth.Group": "fas fa-users",
        # Приложение 'main' (судя по скриншоту)
    ...
    # Красивое отображение иконок по умолчанию
...
JAZZMIN_UI_TWEAKS = {
    ...
    "theme": "flatly", # Светлая, чистая тема (или попробуй "simplex" для минимализма)
